...
应用图标位于 app/：icon-controller.svg 是本项目绘制的矢量源稿，icon-controller.png 是预览，icon-controller.ico 包含 16、20、24、32、40、48、64、128、256 像素版本。它用于 EXE、窗口标题栏和任务栏，不加入后缀图标目录。
